...
```{r}
Florida_Data <- Merged_Covid_Data %>% 
  filter(name == "Florida") 
```


```{r}
Clean_Florida_Data <- Florida_Data %>%  
select(as_of_date.x, total_staff_cases, total_staff_deaths, total_prisoner_cases, total_prisoner_deaths)
