...
scented_data$ScentReview2 <- factor(scented_data$ScentReview , labels = c("Scented", "Unscented"))
```
...
There is a dramatic decrease in the reviews for the scent of candles which may be related to the fact that Covid-19 causes loss of smell in patients.
